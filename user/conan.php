...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["comment_content"])) {
    ...
    header("Location: conan.php");  // Sau khi thêm comment thì chuyển hướng lại trang để tránh submit lại khi reload
    exit;
}

// Truy vấn danh sách comment, lấy nội dung, thời gian tạo và tên người dùng
...
// Hàm lấy thông tin nội dung từ bảng mgcontents dựa trên tên
...
$content = getContentByName($conn, "detective conan");
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
    <title>Conan Blog</title>
...
<body>
    ...
    <div class="banner">
        ...
        <img src="../assets/images/conan.webp" alt="Banner">
    ...
    <div class="main-content">
        <div class="posts">
            <div class="post">
                <img src="../assets/images/detective_conan.jpg" alt="Post 1">
