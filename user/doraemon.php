...
$content = getContentByName($conn, "doraemon");
$content1 = getContentByName($conn, "doraemon: chú khủng long của nobita");
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
    <title>Doraemon Blog</title>
...
<body>
    ...
    <div class="banner">
        ...
        <img src="../assets/images/doraemon.webp" alt="Banner">
    ...
    <div class="main-content">
        <div class="posts">
            <div class="post">
                <img src="../assets/images/doraemon.jpg" alt="Post 1">
                <h2><?php echo htmlspecialchars($content['name'] ?? ''); ?></h2>
                <p><?php echo htmlspecialchars($content['describes'] ?? ''); ?></p>
            </div>
            <div class="post">
                <img src="../assets/images/doraemon_dinosaur.jpg" alt="Post 1">
