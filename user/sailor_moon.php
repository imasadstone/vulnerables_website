...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["comment_content"])) {
    ...
    header("Location: sailor_moon.php");
    exit;
}
...
$content = getContentByName($conn, "sailor moon");
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
    <title>Sailor Moon Blog</title>
...
<body>
    ...
    <div class="banner">
        ...
        <img src="../assets/images/sailor_moon.webp" alt="Banner">
    ...
    <div class="main-content">
        <div class="posts">
            <div class="post">
                <img src="../assets/images/sailor_moon.jpg" alt="Post 1">
