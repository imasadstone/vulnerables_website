...
$content = getContentByName($conn, "naruto dattebayo");
$content1 = getContentByName($conn, "naruto shippuden");
$content2 = getContentByName($conn, "boruto");
?>
<!DOCTYPE html>
<html lang="vi">
<head>
...
<body>
    ...
    <div class="banner">
        ...
        <img src="../assets/images/naruto.avif" alt="Banner">
    ...
    <div class="main-content">
        <div class="posts">
            <div class="post">
                <img src="../assets/images/naruto_dattebayo.jpg" alt="Post 1">
                <h2><?php echo htmlspecialchars($content['name'] ?? ''); ?></h2>
                <p><?php echo htmlspecialchars($content['describes'] ?? ''); ?></p>
            </div>
            <div class="post">
                <img src="../assets/images/naruto_shippuden.jpg" alt="Post 1">
                <h2><?php echo htmlspecialchars($content1['name'] ?? ''); ?></h2>
                <p><?php echo htmlspecialchars($content1['describes'] ?? ''); ?></p>
            </div>
            <div class="post">
                <img src="../assets/images/boruto.webp" alt="Post 1">
                <h2><?php echo htmlspecialchars($content2['name'] ?? ''); ?></h2>
                <p><?php echo htmlspecialchars($content2['describes'] ?? ''); ?></p>
            </div>
        </div>
        <!-- Comment Section -->
